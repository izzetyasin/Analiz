    ...
    public class Ean13
    {
        ...
        public void DrawEan13Barcode(System.Drawing.Graphics g, System.Drawing.PointF pt) //System.Drawing.Point pt )
        {
            ...
            for (int i = 0; i < strbEAN13.Length; i++)
            {
                ...
                {
                    if (xStart == pt.X)
                        xStart = xStart+xPosition;

                    // Save room for the UPC number below the bar code.
                    if ((i > 12 && i < 55) || (i > 57 && i < 101))
                        // Draw space for the number
                        g.FillRectangle(brush, xStart+xPosition, yStart, lineWidth, height - fTextHeight);
                    else
                        // Draw a full line.
                        g.FillRectangle(brush, xStart+xPosition, yStart, lineWidth, height);
                }
            ...
            xPosition = xStart - g.MeasureString(this.CountryCode.Substring(0, 1), font).Width+3;
        ...
        public string ChecksumDigit
        {
            ...
            set
            {
                ...
                if (iValue < 0 || iValue > 9)
                    throw new Exception("Barkod 0 ile 9 arası bir değer içermelidir!");
